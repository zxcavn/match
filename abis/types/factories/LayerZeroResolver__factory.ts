...
import type {
  LayerZeroResolver,
  LayerZeroResolverInterface,
} from "../LayerZeroResolver";
...
export class LayerZeroResolver__factory {
  static readonly abi = _abi;
  static createInterface(): LayerZeroResolverInterface {
    return new utils.Interface(_abi) as LayerZeroResolverInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LayerZeroResolver {
    return new Contract(address, _abi, signerOrProvider) as LayerZeroResolver;
  }
}

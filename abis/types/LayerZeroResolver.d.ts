...
interface LayerZeroResolverInterface extends ethers.utils.Interface {
  functions: {
...
export type UaReceiveVersionSetEvent = TypedEvent<
  [string, number] & { ua: string; version: number }
>;
...
export class LayerZeroResolver extends BaseContract {
  ...
  interface: LayerZeroResolverInterface;
  ...
  filters: {
    ...
    "UaReceiveVersionSet(address,uint16)"(
      ua?: null,
      version?: null
    ): TypedEventFilter<[string, number], { ua: string; version: number }>;

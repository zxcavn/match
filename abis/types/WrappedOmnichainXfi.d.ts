...
interface WrappedOmnichainXfiInterface extends ethers.utils.Interface {
  functions: {
...
export class WrappedOmnichainXfi extends BaseContract {
  ...
  interface: WrappedOmnichainXfiInterface;
